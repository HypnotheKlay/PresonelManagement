...
public class LoginView extends JFrame {
     ...
     *
     */
    private static final long serialVersionUID = -5768783118156735749L;
    ...
    class BookLoginAction implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            user = DaoCheck.check(username.getText(), password.getText());
            if (user.getName() != null) {

                try {

                    FrmEmployeeManage frame = new FrmEmployeeManage();
    ...
    public LoginView() {
        super();
        final FlowLayout borderLayout = new FlowLayout(10,10,10);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        borderLayout.setVgap(10);//设置组件之间的垂直间距
